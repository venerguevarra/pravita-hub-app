...
const { status, data } = await apiInstance.activateModule(
    systemId
);
```
...
const { status, data } = await apiInstance.addActionToModule(
    systemId,
    moduleActionDto
);
```
...
const { status, data } = await apiInstance.deactivateModule(
    systemId
);
```
...
const { status, data } = await apiInstance.removeActionFromModule(
    systemId,
    actionSystemId
);
```
...
const { status, data } = await apiInstance.updateActionForModule(
    systemId,
    actionSystemId,
    moduleActionDto
);
