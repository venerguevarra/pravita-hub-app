...
const { status, data } = await apiInstance.activateTenantRole(
    tenantId,
    systemId
);
```
...
const { status, data } = await apiInstance.createTenantRole(
    tenantId,
    tenantRoleDto
);
```
...
const { status, data } = await apiInstance.deactivateTenantRole(
    tenantId,
    systemId
);
```
...
const { status, data } = await apiInstance.getTenantRole(
    tenantId,
    systemId
);
```
...
const { status, data } = await apiInstance.getTenantRoles(
    tenantId,
    pageRequest
);
```
...
const { status, data } = await apiInstance.updateTenantRole(
    tenantId,
    systemId,
    tenantRoleDto
);
